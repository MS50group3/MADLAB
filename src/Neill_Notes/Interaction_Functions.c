...
{
	instructions_list[0] = "neill_note";
	instructions_list[1] = "coding_stuff";
	instructions_list[2] = "door_jammed";
	instructions_list[3] = "room_too_hot";
	instructions_list[4] = "using_some_code";
	instructions_list[5] = "number";
	instructions_list[6] = "less_than_ten";
	instructions_list[7] = "but_if_we_have";
	instructions_list[8] = "greater_ten";
	instructions_list[9] = "number_eq_eq_ten";
  instructions_list[10] = "number_is_ten";
  instructions_list[11] = "useful_later";
}
